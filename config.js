...
// Auth information
global.pairNumber = "263775843928";                         // Add your paining number with country code example "916297175943"; 
...
global.ownertag = process.env.OWNER_TAG ? process.env.OWNER_TAG.split(",") : ["26377584392"];
global.OwnerName = process.env.OWNER_NAME || "micheal";
global.BotName = process.env.BOT_NAME || "A17";
global.packname = process.env.PACK_NAME || "poster";
