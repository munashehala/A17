...
// Auth information
global.pairNumber = "263775483928";                         // Add your paining number with country code example "916297175943"; 
...
// Owner information
global.Owner = process.env.OWNER ? process.env.OWNER.split(",") : ["263775843928"];
global.OwnerNumber = process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.split(",") : ["263775843928"];
global.ownertag = process.env.OWNER_TAG ? process.env.OWNER_TAG.split(",") : ["263775843928"];
global.OwnerName = process.env.OWNER_NAME || "Pfumela";
global.BotName = process.env.BOT_NAME || "Mushto";
global.packname = process.env.PACK_NAME || "A17 Bot";
global.author = "By: Mushto Pfumela";
...
global.location = process.env.LOCATION || "Harare, Zimbabwe";
